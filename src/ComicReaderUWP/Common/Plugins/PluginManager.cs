...
internal partial class PluginManager
{
    ...
    private void ReadDisabledPlugins()
    {
        ...
        string json = AppDB.AppKV.GetCollection(DatabaseEntry.KV_LIB_PLUGINS).GetValueOrDefault(KEY_DISABLED_PLUGINS, "[]");
    ...
    private void WriteDisabledPlugins()
    {
        ...
        AppDB.AppKV.GetCollection(DatabaseEntry.KV_LIB_PLUGINS).Set(KEY_DISABLED_PLUGINS, json);
    }
